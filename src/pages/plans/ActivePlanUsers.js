// pages/ActivePlanUsers.js - With Pagination & Saffron Theme
    ...
    const UserCard = ({ user }) => (
        <div
            ...
            onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 4px 20px rgba(255,125,56,0.15)';
            }}
            onMouseLeave={e => {
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between">
                        ...
                        <span className="flex items-center gap-1 text-[10px] font-medium px-2 py-0.5 rounded-full whitespace-nowrap"
                            style={{ background: 'rgba(255,125,56,0.2)', color: '#FF7D38' }}>
                            <span className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse" />
                            Active
                        </span>
                    </div>
                    <div className="flex flex-wrap items-center gap-1.5 mt-2">
                        <span className="text-[10px] font-medium px-2 py-0.5 rounded-full" style={{ background: 'rgba(255,125,56,0.15)', color: '#FF7D38' }}>
                            {user.role || 'User'}
                        </span>
                    ...
                    <div className="flex items-center gap-3 mt-2 text-[10px]" style={{ color: '#FF9A5F' }}>
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-wrap">
                    ...
                    <div>
                        <h1 className="text-lg sm:text-xl font-bold" style={{ color: '#FF7D38' }}>Active Users</h1>
            ...
            {filteredUsers.length === 0 ? (
                <div className="text-center py-16 rounded-2xl" style={{ background: 'rgba(2,32,60,0.8)', border: '1px solid rgba(255,125,56,0.15)' }}>
                    <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: 'rgba(255,125,56,0.08)' }}>
                        <UserCheck size={32} style={{ color: '#FF9A5F' }} />
                    </div>
                    <p className="text-sm font-medium" style={{ color: '#FF7D38' }}>No active users found</p>
                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                {paginatedUsers.map(user => (
                                    <tr key={user.id} className="border-b transition-colors" style={{ borderColor: 'rgba(255,125,56,0.06)' }}
                                        ...
                                        <td className="px-4 py-4 text-sm" style={{ color: '#FF7D38' }}>{user.role || 'User'}</td>
                                        <td className="px-4 py-4 text-sm" style={{ color: '#FF7D38' }}>{user.totalDevices || 0}</td>
                                        <td className="px-4 py-4">
                                            <span className="flex items-center gap-1.5 text-xs font-medium" style={{ color: '#FF7D38' }}>
                                                <span className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse" />
                                                Active
                                            </span>
                                        </td>
                                        <td className="px-4 py-4 text-xs" style={{ color: '#FF9A5F' }}>{user.lastSeen || "Just now"}</td>
                                        <td className="px-4 py-4">
